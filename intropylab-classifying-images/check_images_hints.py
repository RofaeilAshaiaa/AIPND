...
def main():
    ...
    # Code to simulate a running piece of code
    # sleep(61)
    ...
    # printing keys and values of pets labels dictionary
...
def get_input_args():
    ...
    parser.add_argument('--arch', type=str, default='vgg', help='CNN model to use for classification')
...
def classify_images(images_dir, petlabel_dic, model):
    ...
    for key in petlabel_dic:
        ...
        # as classifier label
        full_path_image = "pet_images/" + key
        model_label = classifier(full_path_image, model)
